...
=head1 NAME
	...
	getGI.pl -- returns GI numbers from a user specified NCBI database and search term
...
=head2 Usage
	...
	perl getGI.pl -d <name of the database as it appears in NCBI> -t <search term> -o <output file>
