...
# -*- coding: utf-8 -*-
#
# geo-omics-scripts documentation build configuration file, created by
# sphinx-quickstart on Thu Mar 16 15:39:32 2017.
#
...
#
# html_title = 'geo-omics-scripts v0.1'
...
htmlhelp_basename = 'geo-omics-scriptsdoc'
...
man_pages = [
    ...
    ('prep', 'omics-prep', 'prepare compressed fastq data for processing',
     [author], 1),
    ('qc', 'omics-qc', 'run quality control steps on metagenomic Illumina '
     'reads', [author], 1),
